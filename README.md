...
The test coverage report can be generated by executing:

    $ go test -v -coverpkg github.com/e-travel/cloudwatchlogsbeat/beater -coverprofile=coverage.out

The file `coverage.out` can be then viewed using:
